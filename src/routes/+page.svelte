<script lang="ts">
	...
	let timer = tweened((new Date('2023-06-23').getTime()  + new Date('2023-06-23').getTimezoneOffset() * 60000 - Date.now()) / 1000);
	setInterval(() => {
		if ($timer > 0) $timer--;
	}, 1000);
...
>
	...
	<Kinesis class="w-full" translate={0.125}>
		<p class="text-white flex items-center justify-center text-8xl select-none font-noto">디디콘</p>
	</Kinesis>
